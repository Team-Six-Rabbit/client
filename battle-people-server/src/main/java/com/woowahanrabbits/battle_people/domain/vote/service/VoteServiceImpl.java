...
public class VoteServiceImpl implements VoteService {
	...
	private CurrentVoteResponseDto resultDto(Long voteInfoId) {
		...
		List<VoteOpinionDto> opinions = new ArrayList<>();
		opinions.add(new VoteOpinionDto(0, voteOpinions.get(0).getOpinion(), voteCountOpt1,
			100 * voteCountOpt1 / totalCount));

		opinions.add(new VoteOpinionDto(1, voteOpinions.get(1).getOpinion(), voteCountOpt2,

...
function VideoPlayerLeft({ userRank, userName, videoSrc }: VideoPlayerProps) {
	return (
		<div className="w-full h-full flex flex-col items-center">
			<video
				className="w-5/6 h-2/3 mt-6 object-cover rounded-lg me-2 clip-path-left"
				controls
				src={videoSrc}
			>
			...
			<div
				className="w-full flex flex-col items-start text-white p-2 mt-2 ps-10"
				style={borderStyles}
			>
...
function VideoPlayerRight({ userRank, userName, videoSrc }: VideoPlayerProps) {
	return (
		<div className="w-full h-full flex flex-col items-center">
			<div
				className="w-full flex flex-col items-end text-white pe-5"
				style={borderStyles}
			>
				<div className="text-3xl mb-2">{userRank}</div>
				<div className="font-bold text-5xl">{userName}</div>
			...
			<video
				className="w-5/6 h-2/3 mt-4 ms-14 object-cover rounded-lg clip-path-right"
				controls
				src={videoSrc}
			>
				<track kind="captions" srcLang="en" src="captions_en.vtt" default />
